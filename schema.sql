...
-- AUTOMATION TRIGGERS
-- Note: All automation logic has been moved to service layer
-- No triggers are used for stock movements or sales

-- ============================================
-- AUTO-REFRESH TRIGGERS FOR MATERIALIZED VIEWS
-- Note: Dashboard refresh triggers removed - refresh views manually as needed
-- ============================================
